...
╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═══╝      ╚═══╝  ╚═╝╚═╝     ╚═╝]],
			...
			notifier = {
				...
				filter = function(notif)
					if notif.msg and notif.msg:match("Qwen3") then
						return false
					end
					return true
				end,
		...
		keys = {
			...
			},
			{
				...
				desc = "[Snacks] Notification show history",
			},
			{
				"<leader>un",
				function()
			...
			},
			{
				...
				desc = "[Snacks] Goto Type Definitions",
			},
			{
				"<leader>ss",
				function()
